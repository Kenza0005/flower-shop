                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <a href="upload.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-orange-50 hover:border-orange-200 transition">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="font-bold text-gray-900 group-hover:text-orange-700">Upload Restreint</h3>
                                </div>
                                <p class="text-sm text-gray-600">Vérification MIME, renommage et désactivation d'exécution.</p>
                            </a>
                            ...
                            <a href="ping.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-rose-50 hover:border-rose-200 transition">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="font-bold text-gray-900 group-hover:text-rose-700">Audit Réseau</h3>
                                </div>
                                <p class="text-sm text-gray-600">Échappement des commandes et filtrage d'arguments.</p>
                            </a>

                            <!-- Link to Pages -->
                            <a href="page.php?page=home" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-emerald-50 hover:border-emerald-200 transition">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="font-bold text-gray-900 group-hover:text-emerald-700">Pages Statiques</h3>
                                </div>
                                <p class="text-sm text-gray-600">Inclusion par liste blanche sans paramètres dynamiques.</p>
                            </a>
                        </div>
                </div>
