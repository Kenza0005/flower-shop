                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Link to Search -->
                            <a href="search.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-blue-50 hover:border-blue-200 transition">
                            ...
                            <!-- Link to Comments -->
                            <a href="comment.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-purple-50 hover:border-purple-200 transition">
                                <div class="flex items-center mb-3">
                            ...
                            <!-- Link to Upload -->
                            <a href="upload.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-orange-50 hover:border-orange-200 transition">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="font-bold text-gray-900 group-hover:text-orange-700">Upload Fichiers</h3>
                                </div>
                                <p class="text-sm text-gray-600">Testez l'exécution de code à distance (RCE) via upload arbitraire.</p>
                            </a>

                            <!-- Link to Network Tools -->
                            <a href="ping.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-rose-50 hover:border-rose-200 transition">
                                <div class="flex items-center mb-3">
                                    <div class="w-10 h-10 bg-rose-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-rose-200 transition">
                                        <i class="fas fa-network-wired text-rose-600"></i>
                                    </div>
                                    <h3 class="font-bold text-gray-900 group-hover:text-rose-700">Outils Réseau</h3>
                                </div>
                                <p class="text-sm text-gray-600">Testez l'injection de commandes système (Command Injection).</p>
                            </a>

                            <!-- Link to LFI -->
                            <a href="page.php?page=../index.php" class="group p-6 rounded-xl border border-gray-100 bg-gray-50 hover:bg-emerald-50 hover:border-emerald-200 transition">
                                <div class="flex items-center mb-3">
                                    ...
                                    <h3 class="font-bold text-gray-900 group-hover:text-emerald-700">Pages d'Info</h3>
                                </div>
                                <p class="text-sm text-gray-600">Testez l'inclusion locale de fichiers (LFI) via paramètres URL.</p>
                            </a>
                        </div>
                </div>
